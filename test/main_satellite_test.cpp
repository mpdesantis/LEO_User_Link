/******************************************************************************
 * main_satellite_test.cpp
 ******************************************************************************
 * Satellite atomic model.
 *
 * Note: Based on Alternating_Bit_Protocol::main_sender_test.cpp, by Cristina 
 * Ruiz Martin, ARSLab - Carleton University.
 ******************************************************************************
 * Author: M. De Santis
 * CUID: 101213450
 * Date: 2025/03/02
...
int main(){
    ...
    const char * i_input_data_control = "../input_data/satellite_input_test_control_In.txt";
    ...
    const char * i_input_data_ack = "../input_data/satellite_input_test_ack_In.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader_con, input_reader_ack, satellite1};
    ...
    dynamic::modeling::EOCs eocs_TOP = {
        ...
        dynamic::translate::make_EOC<Sender_defs::dataOut,outp_data>("satellite1")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Sender_defs::controlIn>("input_reader_con","satellite1"),
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,Sender_defs::ackIn>("input_reader_ack","satellite1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/satellite_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/satellite_test_output_state.txt");
