...
int main(){
    ...
    const char * i_input_data_control = "../input_data/idu_input_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, idu1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Receiver_defs::out,outp>("idu1")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,Receiver_defs::in>("input_reader","idu1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/idu_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/idu_test_output_state.txt");
